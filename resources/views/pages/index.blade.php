...
<div class="banner">
	<div class="container">
		...
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;"> Green travels - Best in Class for Travel & Hotels</h1>
	</div>
</div>
<div class="container">
